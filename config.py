...
FRONT_CONFLICT_LATERAL_MARGIN = 0.15 # 前车冲突横向包络额外安全边距（米）
...
RIGHT_OBJECT_CROSS_X_MARGIN = 0.5
RIGHT_OBJECT_EGO_TIME_MIN_SPEED = 2.0
RIGHT_OBJECT_PATH_SAMPLE_STEP = 1.0
RIGHT_OBJECT_PATH_LOOKAHEAD = 45.0
RIGHT_OBJECT_LONGITUDINAL_MIN = -30.0
RIGHT_OBJECT_LONGITUDINAL_MAX = 12.0
RIGHT_OBJECT_LATERAL_MIN = -1.0
RIGHT_OBJECT_LATERAL_MAX = 12.0
...
BACKGROUND_VEHICLE_FIXED_SPEEDS = {
    1: 10.0,  # background_vehicle_1 is the vehicle that currently triggers the third avoidance
}
